...
if __name__ == '__main__':
	...
	t = timeit.Timer(lambda: softmax(X, y, stochastic=True, batch_size=128))
	...
	t = timeit.Timer(lambda: one_vs_one(X, y, stochastic=True, batch_size=32))
	print t.timeit(number = 1)
	print "one vs one run over."
	print "Running one vs all..."
	t = timeit.Timer(lambda: one_vs_all(X, y, stochastic=True, batch_size=128))
	print t.timeit(number = 1)
